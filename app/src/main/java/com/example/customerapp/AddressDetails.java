...
public class AddressDetails extends AppCompatActivity {
    ...
    String apiURL = "http://192.168.1.82/food-delivery-application/fooddeliveryapp/public/api/users/address/update";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Nextbillion.getInstance(getApplicationContext(),"b98e9dd2f9414231bae19340b76feff0"); //API
